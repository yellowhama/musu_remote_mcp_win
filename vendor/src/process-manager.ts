...
import { OUTPUT_CHUNK_BYTES, splitOutputChunks, type OutputChunk, type ProcessOutputStream } from "./process-output.js";

const MAX_TIMER_DELAY_MS = 2_147_483_647;

export type { ProcessOutputStream } from "./process-output.js";
